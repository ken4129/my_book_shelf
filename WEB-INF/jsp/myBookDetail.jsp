            ...
            <form action="/MyBookShelf/Main" method="post">
                <div class="container">
                    <div class="form-group my-3">
                        ...
                        <!-- 状態 -->
                        <div class="input-group my-3">
                            <label class="input-group-text" for="inputGroupSelect01">状態</label>
                            <select class="form-select" name="checklist" id="inputGroupSelect01">

                                        <option selected>${ rb.checklist }</option>
